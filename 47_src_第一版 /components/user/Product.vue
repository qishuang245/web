      ...
      //   margin: [200, 560, 380, 550],
        ...
        series: [{
          ...
          nodes: [{
            ...
            id: 'CSO',
            title: '常务副总经理 （技术支撑）',
            name: '刘军  <a href="/#/shp_cto"><i class="el-icon-document"></i>档案</a>',
            ...
            id: 'PR-01',
            title: ' 高级产品经理',
            name: '齐允峰  <a href="/#/shp_cto"><i class="el-icon-document"></i>档案</a>',
            column: 1,
             url:'/solution',
            ...
            id: 'PR-04',
            title: ' 技术支持部经理',
            name: '马海清  <a href="/#/shp_cto"><i class="el-icon-document"></i>档案</a>',
            column: 1,
            image: 'https://wp-assets.highcharts.com/www-highcharts-com/blog/wp-content/uploads/2018/11/13105551/Vidar.jpg'
          },
